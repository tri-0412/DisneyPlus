  ...
  return (
    <div className="flex items-center justify-between p-5">
      <div className="flex items-center gap-8">
        <img src={logo} alt="n" className="w-20 md:w-[115px] object-cover" />
        ...
        {user ? (
          <>
            <button
              ...
              className="flex border-none items-center gap-2 bg-gray-800 text-white px-4 py-2 rounded-full hover:bg-gray-700 transition-colors duration-200"
            >
            ...
            {isModalOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-gray-800 border border-gray-700 rounded-md shadow-lg z-10">
                {/* Thêm tam giác (caret) để liên kết */}
                <div className="absolute -top-3.5 right-4 w-0 h-0 border-l-[10px] border-r-[10px] border-b-[10px] border-l-transparent border-r-transparent border-b-gray-800 transform translate-y-1/2" />
                <button
